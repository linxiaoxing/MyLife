...
public class UndoneFragment extends BaseFragment<UndonePresenterImp> implements UndoneContract.View,
    ...
    protected void initView(View view) {
        ...
        rvFuList.setLayoutManager(new WrapContentLinearLayoutManager(getContext()));
