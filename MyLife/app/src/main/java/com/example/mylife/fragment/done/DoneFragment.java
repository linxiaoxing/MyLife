...
public class DoneFragment extends BaseFragment<DonePresenterImp> implements DoneContract.View,
    ...
    @Override
    public void showDoneTask(TodoTaskDetail datas, int loadType) {
        skeletonScreen.hide();
